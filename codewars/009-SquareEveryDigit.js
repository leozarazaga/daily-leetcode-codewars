...
the function, 811181 will come out, because 9^2 is 81 and 1^2 is 1. (81-1-1-81)

Example #2:
An input of 765 will/should return 493625
...
function squareDigits(num) {
    ...
    return parseInt(numbers.split("").map(value => Math.pow(parseInt(value), 2)).join(""));
}
